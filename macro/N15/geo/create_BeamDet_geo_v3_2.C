...
TString geoFileName = geoPath + "/geometry/N15.base.geo.root";
// --------------------------------------------------------------------------
...
TGeoVolume* gasCone = gGeoManager->MakeCone("gas",pmisobutan003, dz/2, rmin1,rmax1, rmin2,rmax2);
...
TGeoVolume *Shell_Z = gGeoManager->MakeTube("Shell_Z", pmaluminium, rmax1-0.001, rmax1, shell_Z/2);
...
TGeoVolume* Si = gGeoManager->MakeTube("plastic", silicon_Si, 0,SiR, SiZ/2);
