...
//----------------------------------
  ...
  **/
  ...
  //generator->AddBackgroundIon("Triton",1,3,1,0.1/*percantage of mixture*/);
...
/////////////////////////////////////////////////////////////////////////////
  ...
  targetDecay->SetMaxPathLength(0.63);
  targetDecay->SetDecayFile(datFile.Data(), 0.001 /*excitation in file [GeV]*/);
  targetDecay->SetHe10Exitation(0.0021, 0.002, 1);	//[GeV] should be omitted in future in case of decay file
  ...
  //geant trajectories info is put in file gconfig/g4config.in
  //change /tracking/verbose 0 to /tracking/verbose 1
