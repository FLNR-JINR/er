void sim(Int_t nEvents = 20000, Int_t index = 0) {
  //---------------------Files-----------------------------------------------
...
//TString outFile = "/store/ivan/simNeuRadJULY/sim.root";//
//TString parFile = "/store/ivan/simNeuRadJULY/par.root";
  ...
  */
  ...
  boxGen->SetBoxXYZ(-0.19,-2.4,0.19,2.4,4.4);
 // boxGen->SetBoxXYZ(-0.149,-0.149,0.149,0.149,19.4); // NeuRad tests dubna
