void draw2graph(){
	...
	TString f1name = "out.root";

	TFile *f1 = new TFile(f1name);
	
	TString histName2 = "Neutron. EKin=500MeV. Sum Energy deposit";
    TString histName1 = "500MeV neutron. Sum light yeild.";
	TString newHistName = "Sum Energy deposit and Light yield of all fibers in event. E_{kin}^{n}=500 MeV,Geant4,BERT,rCut = 0.7 mm, Cut=100KeV";
