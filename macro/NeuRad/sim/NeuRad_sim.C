void NeuRad_sim(Int_t nEvents,TString outFile, TString parFile, Double_t Ekin){
  //---------------------Files-----------------------------------------------
  //TString outFile= "sim500MeV100000evfc.root";
  //TString parFile= "par500MeV100000evfc.root";
  // ------------------------------------------------------------------------
  ...
  */
  ...
  boxGen->SetBoxXYZ (0.0,0.,0.6,0.6,-50.);
