...
//------------------ Silicon box   -----------------------------------------
Double_t box_Si_X = fiber_X /  64;   //cm
Double_t box_Si_Y = fiber_Y;   //cm
Double_t box_Si_Z = fiber_Z;  //cm
// box_Si_X /= 2.;
// box_Si_Y /= 2.;
// box_Si_Z /= 2.;
TGeoVolume *box_Si = gGeoManager->MakeBox("box_Si", psilicon, box_Si_X, box_Si_Y, box_Si_Z);
...
{
  Double_t box_Si_in_fiber_X_trans = fiber_X - box_Si_X - box_Si_X * 2. * i_box_Si ;
