...
Double_t rotAngle = 5.;          // this parameter should coincide with magnetic field rotation angle
Double_t magnetCenterZ = 70.;     // this parameter should coincide with "fieldTransZ" from /macro/EXP1803/fielDataToERFormat.C
Double_t distToMagnetCenter = 100.;
