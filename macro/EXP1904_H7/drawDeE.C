void drawDeE() {
    ...
    t_er->Add("results/h7_ct_00_000*.cleaned.root");
    TChain* reco_er = new TChain("er");
    reco_er->Add("results/h7_ct_00_000*.reco.root");
    ...
    Int_t nentries = t_er->Draw("a20_1 : a1_1 + a20_1_un", "mult1 && mult_1 && ((fXt)*(fXt) + (fYt)*(fYt))<1.*1.");
    std::cout << nentries << std::endl;
    c->cd(2);
    nentries = t_er->Draw("a20_2 : a1_2 + a20_2_un", "mult2 && mult_2 && ((fXt)*(fXt) + (fYt)*(fYt))<1.*1.");
    std::cout << nentries << std::endl;
    c->cd(3);
    nentries = t_er->Draw("a20_3 : a1_3 + a20_3_un", "mult3 && mult_3 && ((fXt)*(fXt) + (fYt)*(fYt))<1.*1.");
    std::cout << nentries << std::endl;
    c->cd(4);
    nentries = t_er->Draw("a20_4 : a1_4 + a20_4_un", "mult4 && mult_4 && ((fXt)*(fXt) + (fYt)*(fYt))<1.*1.");
    std::cout << nentries << std::endl;
}