...
//     }
  ...
  if (sq20times) {
    ...
    { 
      ...
      hdraw.Form("a20_1:t20_1-tF5 >> h_tsq20_%d(300,0,120,300,0,20)",i);
      ch->Draw(hdraw.Data(),cut.Data(),"");
...
if (tSQ1_1) {
    ...
    { Int_t i=0;
      ...
      cut.Form("n1_2==%d && flag2",i);
      hdraw.Form("a1_2:t1_2-tF5 >> h_X_L_%d(2000,0,100,2000,-10,60)",i);
      ch->SetMarkerColor(kBlack);
      ch->Draw(hdraw.Data(),cut.Data(),"col");
      ...
      cut.Form("n1_2==%d && flag2",i);
      hdraw.Form("a1_2:t1_2-tF5 >> h_X_Lhe3_%d(2000,0,100,2000,-10,60)",i);
      ch->SetMarkerColor(kRed);
      ch->Draw(hdraw.Data(),cut.Data(),"same");
