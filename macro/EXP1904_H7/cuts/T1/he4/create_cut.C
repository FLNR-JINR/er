...
void create_cut(){
  ...
  if (he3_1) {
    ...
    cut.Form("flag1 && a1_1+a20_1_un<30 && a20_1<5  ");
    hdraw.Form("a20_1:a1_1+a20_1_un>>h%d1(3000,0,30,3000,0,5)",i);
    // hdraw.Form("X_C.:aCsI>>h%d",i);
    ...
    cuthe4_1->SetLineColor(kGreen);
    cuthe4_1->SetLineWidth(3);
    cuthe4_1->Draw("same");
    c3h_1->Update();
    ...
    ch->SetMarkerStyle(1);
    ch->SetMarkerColor(kBlack);      
    cut.Form("flag2 && a1_2+a20_2_un<30 && a20_2<5  ");
    hdraw.Form("a20_2:a1_2+a20_2_un>>h%d2(3000,0,30,3000,0,5)",i);
    ch->Draw(hdraw.Data(),cut.Data(),"col");
    c3h_1->Update();
    ...
    cuthe4_2->SetLineColor(kGreen);
    cuthe4_2->SetLineWidth(3);    
    cuthe4_2->Draw("same");
    c3h_1->Update();
    ...
    ch->SetMarkerStyle(1);
    ch->SetMarkerColor(kBlack);      
    cut.Form("flag3 && a1_3+a20_3_un<30 && a20_3<5  ");
    hdraw.Form("a20_3:a1_3+a20_3_un>>h%d3(3000,0,30,3000,0,5)",i);
    ch->Draw(hdraw.Data(),cut.Data(),"col");
    c3h_1->Update();
    ...
    cuthe4_3->SetLineColor(kGreen);
    cuthe4_3->SetLineWidth(3);    
    cuthe4_3->Draw("same");
    c3h_1->Update();
    ...
    ch->SetMarkerStyle(1);
    ch->SetMarkerColor(kBlack);      
    cut.Form("flag4 && a1_4+a20_4_un<30 && a20_4<5  ");
    hdraw.Form("a20_4:a1_4+a20_4_un>>h%d4(3000,0,30,3000,0,5)",i);
    ch->Draw(hdraw.Data(),cut.Data(),"col");
    c3h_1->Update();
    ...
    cuthe4_4->SetLineColor(kGreen);
    cuthe4_4->SetLineWidth(3);    
    cuthe4_4->Draw("same");
    c3h_1->Update();

    c3h_1->Print("/home/muzalevskii/Desktop/he4_id.png");
  }
