void drawCut(){
  ...
  if (tCsI_s) {
    ...
    {Int_t i=15;
      ...
      ch->SetMarkerStyle(1);
      ch->SetMarkerColor(kBlack);      
      cut.Form("nCsI==%d && tCsI-tF5>300 && tCsI-tF5<500",i);
      hdraw.Form("aCsI:tCsI-tF5 >> h_CsI_1_%d",i);
      ch->Draw(hdraw.Data(),cut.Data(),"");

      ch->SetMarkerColor(kRed);
      cut.Form("nCsI==%d && tCsI-tF5>300 && tCsI-tF5<500 && nh3",i);
      hdraw.Form("aCsI:tCsI-tF5 >> h_CsI_h3_%d",i);
      ch->Draw(hdraw.Data(),cut.Data(),"same");

      ch->SetMarkerColor(kBlue);
      ch->SetMarkerStyle(20);
      cut.Form("nCsI==%d && tCsI-tF5>300 && tCsI-tF5<500 && nh3 && nhe3_1",i);
      hdraw.Form("aCsI:tCsI-tF5 >> h_CsI_hcoin_%d",i);
      ch->Draw(hdraw.Data(),cut.Data(),"same");
  ...
  if (centtimes) {
      ...
      // c5->cd(i+1);
    {
      ...
      ch->SetMarkerColor(kBlack);  
      ch->Draw("X_C:tX_C - tF5 >> (500,250,)",cutName.Data(),"");
...
if (sq20Rtimes) {
  ...
  if (X_Lcuts) {
    ...
    // { Int_t i=12;
      ...
      hdraw.Form("X_L:tX_L-tF5 >> h_X_L_%d(2000,-60,100,2000,0,100)",i);
      ch->SetMarkerColor(kBlack);
      ch->Draw(hdraw.Data(),cut.Data(),"");

      // ch->SetMarkerStyle(20);
      cut.Form("nX_L==%d && tX_L-tF5<200 && flagLeft",i);
      hdraw.Form("X_L:tX_L-tF5 >> h_X_Lhe3_%d(2000,-60,100,2000,0,100)",i);
      ch->SetMarkerColor(kRed);
      ch->Draw(hdraw.Data(),cut.Data(),"same");

      // ch->SetMarkerStyle(1);
      // cut.Form("nX_L==%d && tX_L-tF5<200 && nhe4",i);
      // hdraw.Form("X_L:tX_L-tF5 >> h_X_Lhe4_%d(2000,-60,100,2000,0,100)",i);
      // ch->SetMarkerColor(kBlue);
      // ch->Draw(hdraw.Data(),cut.Data(),"same");

      // ch->SetMarkerStyle(20);
      // cut.Form("nX_L==%d && tX_L-tF5<200 && nhe8",i);
      // hdraw.Form("X_L:tX_L-tF5 >> h_X_Lhe4_%d(2000,-60,100,2000,0,100)",i);
      // ch->SetMarkerColor(kMagenta);
      // ch->Draw(hdraw.Data(),cut.Data(),"same");
