void expCalib_reco() {
  ...
  qtelescopeTrackFinder->SetHitStation("Telescope_1", "Telescope_1_DoubleSi_SSD20_1_YX_1_X",
                                                      "Telescope_1_DoubleSi_SSD20_1_YX_0_Y");
  ...
  qtelescopePID->SetStationParticle("Telescope_1_DoubleSi_SSD20_1_YX_1_XTelescope_1_DoubleSi_SSD20_1_YX_0_Y", 1000020040);
