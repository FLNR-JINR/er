void expCalib_sim_nonUni (Int_t nEvents = 1) {
  //---------------------Files-----------------------------------------------
  ...
  **/
  ...
  ERGeoSubAssembly* telescope1 = new ERGeoSubAssembly("Telescope_1", TVector3(0, 0, l), TVector3());
  ...
  // ERQTelescopeGeoNonUniformSingleSi* thick_1 = new ERQTelescopeGeoNonUniformSingleSi("SingleSi", "SingleSi_SSD_1", "X", 16,
  //                                                                                   "../input/map_sens.root",
  ...
  telescope1->AddComponent(thick_1, TVector3(0, 0, 0.), TVector3(0, 0, 0));
