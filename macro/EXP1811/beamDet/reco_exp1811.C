void reco_exp1811(Int_t nEvents = 140000){
  //---------------------Files-----------------------------------------------
  TString inFile  = "~/ER/showBeam_VC/analysed/he8_10_0010.Digi.root";
  TString outFile = "~/ER/showBeam_VC/reco/he8_10_0010.recoER.root";
  ...
  //run->SetUserCut("EventHeader.fTrigger==2");
  //run->SetUserCut("EventHeader.fTrigger==1");
 run->SetUserCut("EventHeader.fTrigger==3");
