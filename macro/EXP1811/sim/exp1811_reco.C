void exp1811_reco(Int_t nEvents = 10000000){
  ...
  qtelescopePID->SetTrackForParticle("Central_telescope_DoubleSi_DSD_C_XY_0", 1000010030);
  qtelescopePID->SetTrackForParticle("Central_telescope_CsI_0", 1000010030);

  qtelescopePID->SetTrackForParticle("Left_telescope_SingleSi_SSD20_L_X_0", 1000020030);
  qtelescopePID->SetTrackForParticle("Left_telescope_DoubleSi_DSD_L_XY_0", 1000020030);
  qtelescopePID->SetTrackForParticle("Left_telescope_SingleSi_SSD_L_X_0", 1000020030);

  qtelescopePID->SetTrackForParticle("Right_telescope_SingleSi_SSD20_R_X_0", 1000020030);
  qtelescopePID->SetTrackForParticle("Right_telescope_SingleSi_SSDY_R_Y_0", 1000020030);
  qtelescopePID->SetTrackForParticle("Right_telescope_SingleSi_SSD_R_Y_0", 1000020030);
