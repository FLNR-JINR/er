...
#include "ERNeuRadPointAnalyser.h"

const Double_t ERNeuRadPointAnalyser::fHistoELossThreshold = 100.;

// ----------------------------------------------------------------------------
ERNeuRadPointAnalyser::ERNeuRadPointAnalyser()
  : FairTask("ER NeuRad Point analyse")
{
}
// ----------------------------------------------------------------------------

// ----------------------------------------------------------------------------
ERNeuRadPointAnalyser::ERNeuRadPointAnalyser(Int_t verbose)
  : FairTask("ER NeuRad Point analyse")
{  
}
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
void ERNeuRadPointAnalyser::SetParContainers()
{
...
// ----------------------------------------------------------------------------
InitStatus ERNeuRadPointAnalyser::Init()
{
    // Get input array
...
// -----   Public method Exec   --------------------------------------------
void ERNeuRadPointAnalyser::Exec(Option_t* opt)
{
...
// ----------------------------------------------------------------------------
void ERNeuRadPointAnalyser::Reset()
{
}
// ----------------------------------------------------------------------------

// ----------------------------------------------------------------------------
void ERNeuRadPointAnalyser::Finish()
{  
...
ClassImp(ERNeuRadPointAnalyser)
