// -------------------------------------------------------------------------
// -----                      ERNeuRadPMTSignalLP source file            -----
// -------------------------------------------------------------------------
...
// -----   Default constructor   -------------------------------------------
ERNeuRadPMTSignalLP::ERNeuRadPMTSignalLP(){

}
// -------------------------------------------------------------------------
// -----   Constructor with arguments   ------------------------------------
ERNeuRadPMTSignalLP::ERNeuRadPMTSignalLP(Int_t iBundle, Int_t iFiber)
...
// -------------------------------------------------------------------------
void ERNeuRadPMTSignalLP::AddFiberPoint(ERNeuRadFiberPoint* fpoint){
...
//-------------------------------------------------------------------------
vector<Double_t> ERNeuRadPMTSignalLP::GetIntersections(Double_t discriminatorThreshold){
...
//-------------------------------------------------------------------------
Double_t ERNeuRadPMTSignalLP::GetMaxInteg(const Double_t window, const Double_t dt){
...
//-------------------------------------------------------------------------
Double_t ERNeuRadPMTSignalLP::GetInteg(const Double_t start,const Double_t finish){
...
//-------------------------------------------------------------------------
Double_t ERNeuRadPMTSignalLP::GetMean(const Double_t time){
  SignalPointsMap::iterator itSp= fSignalPoints.begin();
...
//-------------------------------------------------------------------------
Double_t ERNeuRadPMTSignalLP::GetFirstInteg(const Double_t window){
  return GetInteg(GetStartTime(),GetStartTime()+window );
}
//-------------------------------------------------------------------------

//-------------------------------------------------------------------------
Double_t ERNeuRadPMTSignalLP::GetStartTime(){
  return fSignalPoints.begin()->first;
}
//-------------------------------------------------------------------------

//-------------------------------------------------------------------------
Double_t ERNeuRadPMTSignalLP::GetFinishTime(){
