...
class ERQTelescopeSiPoint : public FairMCPoint
{
 ...
 public:
   ...
   **/
  ERQTelescopeSiPoint(Int_t eventID, 
                  Int_t trackID,
                  Int_t mot0trackID,
                  Int_t pid,
                  TVector3 posIn,
                  TVector3 posOut, TVector3 momIn, TVector3 momOut,
                  Double_t tof, Double_t length, Double_t eLoss, Int_t stationNb, Int_t stripNb);
  ...
  Int_t GetStationNb()      const { return fStationNb;}
  Int_t GetStripNb()        const { return fStripNb;}
