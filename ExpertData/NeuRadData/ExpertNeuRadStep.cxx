...
// -----   Default constructor   -------------------------------------------
ExpertNeuRadStep::ExpertNeuRadStep()
  : fX(0.), fY(0.), fZ(0.),
    fPx(0.), fPy(0.), fPz(0.)
{
}
...
ExpertNeuRadStep::ExpertNeuRadStep(Int_t eventID, Int_t stepNr,Int_t trackID,
		  Int_t mot0trackID,
...
// -------------------------------------------------------------------------
ExpertNeuRadStep::ExpertNeuRadStep(const ExpertNeuRadStep& right)
