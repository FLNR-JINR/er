...
#ifndef ExpertNeuRadPoint_H
#define ExpertNeuRadPoint_H
...
class ExpertNeuRadPoint : public FairMCPoint 
{
 ...
 public:
  ...
  /** Copy constructor **/
  ExpertNeuRadPoint(const ExpertNeuRadPoint&);


  /** Destructor **/
  virtual ~ExpertNeuRadPoint();


  ExpertNeuRadPoint& operator=(const ExpertNeuRadPoint&) { return *this; }
