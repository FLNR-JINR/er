// -------------------------------------------------------------------------
// -----                    ERFieldConst header file                   -----
// -----                Created /01/04  by V.Schetinin                 ----- 
// -------------------------------------------------------------------------


#ifndef ERFieldConst_H
#define ERFieldConst_H 1

#include "FairField.h"

class ERFieldPar;

class ERFieldConst : public FairField
{
 public:    
  /** Default constructor **/
  ERFieldConst();
   ...
   **/
  ERFieldConst(const char* name, Double_t xMin, Double_t xMax,
