...
#ifndef detectorPoint_H
#define detectorPoint_H
...
class detectorPoint : public FairMCPoint 
{
 ...
 public:
   ...
   **/
  detectorPoint(Int_t eventID, Int_t trackID,
		  Int_t mot0trackID,
		  Double_t mass,
		  TVector3 posIn,
  ...
  /** Copy constructor **/
  detectorPoint(const detectorPoint&);
  ...
  detectorPoint& operator=(const detectorPoint&) { return *this; }
